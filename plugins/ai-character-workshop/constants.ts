...
export const NAMING_CULTURES = [
  ...
  { value: 'korean', label: { zh: '韩文', en: 'Korean' } },
  { value: 'western', label: { zh: '西方', en: 'Western' } },
  { value: 'russian', label: { zh: '俄罗斯', en: 'Russian' } },
  { value: 'arabic', label: { zh: '阿拉伯', en: 'Arabic' } },
  { value: 'indian', label: { zh: '印度', en: 'Indian' } },
  { value: 'latin', label: { zh: '拉丁美洲', en: 'Latin American' } },
  { value: 'african', label: { zh: '非洲', en: 'African' } },
  { value: 'southeast_asian', label: { zh: '东南亚', en: 'Southeast Asian' } },
  { value: 'nordic', label: { zh: '北欧', en: 'Nordic' } },
  { value: 'greek', label: { zh: '希腊', en: 'Greek' } },
  ...
  fantasy: [
    {
      ...
      tags: [
        ...
        { value: 'half-elf', label: { zh: '半精灵', en: 'Half-Elf' } },
        { value: 'orc', label: { zh: '兽人', en: 'Orc' } },
        { value: 'demon', label: { zh: '恶魔', en: 'Demon' } },
        { value: 'angel', label: { zh: '天使', en: 'Angel' } },
        { value: 'vampire', label: { zh: '吸血鬼', en: 'Vampire' } },
        { value: 'werewolf', label: { zh: '狼人', en: 'Werewolf' } },
        { value: 'fairy', label: { zh: '妖精', en: 'Fairy' } },
        { value: 'beastkin', label: { zh: '兽人族', en: 'Beastkin' } },
        { value: 'undead', label: { zh: '亡灵', en: 'Undead' } },
        { value: 'giant', label: { zh: '巨人', en: 'Giant' } },
        { value: 'merfolk', label: { zh: '人鱼', en: 'Merfolk' } },
        { value: 'spirit', label: { zh: '精怪', en: 'Spirit' } },
      ],
    },
    {
      category: '职业',
      tags: [
        ...
        { value: 'paladin', label: { zh: '圣骑士', en: 'Paladin' } },
        { value: 'ranger', label: { zh: '游侠', en: 'Ranger' } },
        { value: 'assassin', label: { zh: '刺客', en: 'Assassin' } },
        { value: 'necromancer', label: { zh: '死灵法师', en: 'Necromancer' } },
        { value: 'bard', label: { zh: '吟游诗人', en: 'Bard' } },
        { value: 'monk', label: { zh: '武僧', en: 'Monk' } },
        { value: 'druid', label: { zh: '德鲁伊', en: 'Druid' } },
        { value: 'warlock', label: { zh: '术士', en: 'Warlock' } },
        { value: 'alchemist', label: { zh: '炼金术士', en: 'Alchemist' } },
        { value: 'summoner', label: { zh: '召唤师', en: 'Summoner' } },
        { value: 'knight', label: { zh: '骑士', en: 'Knight' } },
        { value: 'archer', label: { zh: '弓箭手', en: 'Archer' } },
      ],
    },
  ],
  scifi: [
    {
      ...
      tags: [
        ...
        { value: 'clone', label: { zh: '克隆人', en: 'Clone' } },
        { value: 'ai', label: { zh: '人工智能', en: 'AI' } },
        { value: 'mutant', label: { zh: '变异人', en: 'Mutant' } },
        { value: 'alien', label: { zh: '外星人', en: 'Alien' } },
        { value: 'psychic', label: { zh: '超能力者', en: 'Psychic' } },
        { value: 'spacer', label: { zh: '太空人', en: 'Spacer' } },
        { value: 'netrunner', label: { zh: '网络骇客', en: 'Netrunner' } },
        { value: 'bounty-hunter', label: { zh: '赏金猎人', en: 'Bounty Hunter' } },
      ],
    },
    {
      category: '阵营',
      tags: [
        { value: 'rebel', label: { zh: '反抗军', en: 'Rebel' } },
        { value: 'corporate', label: { zh: '企业', en: 'Corporate' } },
        { value: 'mercenary', label: { zh: '雇佣兵', en: 'Mercenary' } },
        { value: 'scientist', label: { zh: '科学家', en: 'Scientist' } },
        { value: 'military', label: { zh: '军方', en: 'Military' } },
        { value: 'pirate', label: { zh: '太空海盗', en: 'Space Pirate' } },
        { value: 'colonist', label: { zh: '殖民者', en: 'Colonist' } },
        { value: 'syndicate', label: { zh: '辛迪加', en: 'Syndicate' } },
        { value: 'nomad', label: { zh: '流浪者', en: 'Nomad' } },
        { value: 'government', label: { zh: '政府', en: 'Government' } },
      ],
    },
  ],
  modern: [
    {
      category: '职业',
      tags: [
        { value: 'detective', label: { zh: '侦探', en: 'Detective' } },
        { value: 'journalist', label: { zh: '记者', en: 'Journalist' } },
        { value: 'doctor', label: { zh: '医生', en: 'Doctor' } },
        { value: 'lawyer', label: { zh: '律师', en: 'Lawyer' } },
        { value: 'teacher', label: { zh: '教师', en: 'Teacher' } },
        { value: 'artist', label: { zh: '艺术家', en: 'Artist' } },
        { value: 'police', label: { zh: '警察', en: 'Police' } },
        { value: 'chef', label: { zh: '厨师', en: 'Chef' } },
        { value: 'programmer', label: { zh: '程序员', en: 'Programmer' } },
        { value: 'musician', label: { zh: '音乐家', en: 'Musician' } },
        { value: 'athlete', label: { zh: '运动员', en: 'Athlete' } },
        { value: 'writer', label: { zh: '作家', en: 'Writer' } },
        { value: 'photographer', label: { zh: '摄影师', en: 'Photographer' } },
        { value: 'nurse', label: { zh: '护士', en: 'Nurse' } },
        { value: 'pilot', label: { zh: '飞行员', en: 'Pilot' } },
        { value: 'soldier', label: { zh: '军人', en: 'Soldier' } },
      ],
    },
    {
      category: '身份',
      tags: [
        ...
        { value: 'office-worker', label: { zh: '上班族', en: 'Office Worker' } },
        { value: 'entrepreneur', label: { zh: '创业者', en: 'Entrepreneur' } },
        { value: 'celebrity', label: { zh: '名人', en: 'Celebrity' } },
        { value: 'freelancer', label: { zh: '自由职业者', en: 'Freelancer' } },
        { value: 'ceo', label: { zh: '企业高管', en: 'CEO' } },
        { value: 'influencer', label: { zh: '网红', en: 'Influencer' } },
        { value: 'heir', label: { zh: '继承人', en: 'Heir' } },
        { value: 'orphan', label: { zh: '孤儿', en: 'Orphan' } },
        { value: 'immigrant', label: { zh: '移民', en: 'Immigrant' } },
      ],
    },
    {
      category: '特质',
      tags: [
        { value: 'mysterious-past', label: { zh: '神秘过去', en: 'Mysterious Past' } },
        { value: 'double-life', label: { zh: '双重身份', en: 'Double Life' } },
        { value: 'witness', label: { zh: '目击者', en: 'Witness' } },
        { value: 'suspect', label: { zh: '嫌疑人', en: 'Suspect' } },
        { value: 'genius', label: { zh: '天才', en: 'Genius' } },
        { value: 'amnesiac', label: { zh: '失忆者', en: 'Amnesiac' } },
        { value: 'undercover', label: { zh: '卧底', en: 'Undercover' } },
        { value: 'survivor', label: { zh: '幸存者', en: 'Survivor' } },
      ],
    },
  ],
  techwear: [
    {
      ...
      tags: [
        ...
        { value: 'futuristic', label: { zh: '未来风', en: 'Futuristic' } },
      ],
    },
    {
      category: '身份',
      tags: [
        { value: 'courier', label: { zh: '快递员', en: 'Courier' } },
        { value: 'urban-ninja', label: { zh: '都市忍者', en: 'Urban Ninja' } },
        { value: 'tech-specialist', label: { zh: '技术专家', en: 'Tech Specialist' } },
        { value: 'street-artist', label: { zh: '街头艺术家', en: 'Street Artist' } },
      ],
    },
  ],
  historical: [
    {
      category: '身份',
      tags: [
        { value: 'noble', label: { zh: '贵族', en: 'Noble' } },
        { value: 'peasant', label: { zh: '平民', en: 'Peasant' } },
        { value: 'merchant', label: { zh: '商人', en: 'Merchant' } },
        { value: 'soldier', label: { zh: '士兵', en: 'Soldier' } },
      ],
    },
    {
      category: '职业',
      tags: [
        { value: 'knight', label: { zh: '骑士', en: 'Knight' } },
        { value: 'scholar', label: { zh: '学者', en: 'Scholar' } },
        { value: 'artisan', label: { zh: '工匠', en: 'Artisan' } },
        { value: 'priest', label: { zh: '神职人员', en: 'Priest' } },
      ],
    },
  ],
  custom: [
    {
      category: '通用',
      tags: [
        { value: 'protagonist', label: { zh: '主角', en: 'Protagonist' } },
        { value: 'antagonist', label: { zh: '反派', en: 'Antagonist' } },
        { value: 'mentor', label: { zh: '导师', en: 'Mentor' } },
        { value: 'sidekick', label: { zh: '助手', en: 'Sidekick' } },
      ],
    },
  ],
};
